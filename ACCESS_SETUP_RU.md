...
3. Выбрать нужный режим:
   - `Быстрое обновление Shipox (30 дней)` - последние 30 календарных дней.
   - `Глубокое обновление Shipox (3 месяца)` - последние 3 месяца.
4. Нажать `Run workflow`.

Ничего вводить не нужно. Внутри уже стоят рабочие настройки:

```text
quick: последние 30 дней
deep: последние 3 месяца
concurrency: 4
